...
def login (user, password):
    ...
    syslog.syslog('Successfully logged in as ' + user)

def add_to_cart():
    # print('INFO: Adding all 6 items to cart')
    syslog.syslog('Adding all 6 items to cart')
    ...
    for item in items:
        ...
        syslog.syslog(product + ' added to the cart')
        item.click()
